...
-- GenItem("skill", "skill_fade_armor_chain");
-- GenItem("skill", "skill_fade_armor_diamond");

--GenItem("misc", "war_bread");
-- GenItem("misc", "nano_mender_basic");
...
GenItem("misc", "weapon_prototype")
GenItem("misc", "weapon_burnt")
--GenItem("skill", "skill_radar_creature")
-- GenItem("skill", "clone_block")

-- for i = 0,3 do 
-- 	GenItem("misc/uno", "uno_" .. i)
-- end
