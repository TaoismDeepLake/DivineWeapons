...
//
//    //GENERAL
//    public static boolean GIVE_STARTER_ITEMS = ModConfig.GENERAL_CONF.GIVE_STARTER_ITEMS;
//
//    //Crafting
...
//        MONK_BEADS_MAX_EFFECTIVE_LEVEL = config.getInt("MONK_BEADS_MAX_EFFECTIVE_LEVEL", category, -1, -1, Int.MaxValue(),"The monk beads can't give xp when the player is over this level. (-1 = unlimited)");
//
//        config.save();
//    }
//
