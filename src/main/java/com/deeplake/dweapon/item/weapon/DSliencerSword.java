...
//WIP
public class DSliencerSword extends DWeaponSwordBase {
	// /give @p dweapon:blood_sword 1 0 {is_earth:false, is_sky:false, pearl_count:0}
	public DSliencerSword(String name, ToolMaterial material) {
		super(name, material);
	...
	//---
	@SubscribeEvent
	public static void onSound(SoundEvent event) {
		//event.
	}
