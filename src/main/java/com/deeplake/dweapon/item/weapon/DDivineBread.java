...
//Just for copying
public class DDivineBread extends DWeaponSwordBase {
	// /give @p dweapon:divine_bread 1 0 {is_earth:false, is_sky:false, pearl_count:0}
	public DDivineBread(String name, ToolMaterial material) {
		super(name, material);
